...
previous_travel1 = Travel.find_or_create_by(route: rauch_laplata, date_departure: (DateTime.now - 1.months), date_arrival: (DateTime.now - 1.months + 4.hours), price: 900, driver: driver1, combi: combi1, status: :finished)
previous_travel2 = Travel.find_or_create_by(route: rauch_laplata, date_departure: (DateTime.now - 2.months), date_arrival: (DateTime.now - 2.months + 4.hours), price: 900, driver: driver1, combi: combi1, status: :finished)
previous_travel3 = Travel.find_or_create_by(route: laplata_tandil, date_departure: (DateTime.now - 3.months), date_arrival: (DateTime.now - 3.months + 4.hours), price: 900, driver: driver1, combi: combi1, status: :finished)
previous_travel4 = Travel.find_or_create_by(route: laplata_villalaangostura, date_departure: (DateTime.now - 4.months), date_arrival: (DateTime.now - 4.months + 1.days), price: 4000, driver: driver2, combi: combi2, status: :finished)
previous_travel5 = Travel.find_or_create_by(route: villalaangostura_tandil, date_departure: (DateTime.now - 5.months), date_arrival: (DateTime.now - 5.months + 1.days), price: 4000, driver: driver3, combi: combi3, status: :finished)
previous_travel6 = Travel.find_or_create_by(route: rauch_laplata, date_departure: (DateTime.now - 6.months), date_arrival: (DateTime.now - 6.months + 4.hours), price: 900, driver: driver1, combi: combi1, status: :finished)
previous_travel7 = Travel.find_or_create_by(route: chascomus_posadas, date_departure: (DateTime.now - 7.months), date_arrival: (DateTime.now - 7.months + 9.hours), price: 900, driver: driver4, combi: combi4, status: :finished)
previous_travel8 = Travel.find_or_create_by(route: chascomus_posadas, date_departure: (DateTime.now - 8.months), date_arrival: (DateTime.now - 7.months + 9.hours), price: 900, driver: driver5, combi: combi5, status: :finished)
previous_travel9 = Travel.find_or_create_by(route: posadas_laplata, date_departure: (DateTime.now - 9.months), date_arrival: (DateTime.now - 9.months + 9.hours), price: 900, driver: driver5, combi: combi5, status: :finished)

# Create current travels
current_travel1 = Travel.find_or_create_by(route: rauch_laplata, date_departure: (DateTime.now), date_arrival: (DateTime.now + 5.hours), price: 900, discount: 0, driver: driver1, combi: combi1, status: :started)
current_travel2 = Travel.find_or_create_by(route: laplata_tandil, date_departure: (DateTime.now), date_arrival: (DateTime.now + 4.hours), price: 900, discount: 0, driver: driver2, combi: combi2, status: :started)
current_travel3 = Travel.find_or_create_by(route: laplata_villalaangostura, date_departure: (DateTime.now), date_arrival: (DateTime.now + 1.days), price: 4000, discount: 50, driver: driver3, combi: combi3, status: :started)
current_travel4 = Travel.find_or_create_by(route: villalaangostura_tandil, date_departure: (DateTime.now), date_arrival: (DateTime.now + 1.days), price: 4000, discount: 0, driver: driver4, combi: combi4)
...
#current_travel7 = Travel.find_or_create_by(route: chascomus_rauch, date_departure: (DateTime.now - 10.minutes), date_arrival: (DateTime.now + 9.hours), price: 900, discount: 0, driver: driver6, combi: combi6)
...
Ticket.find_or_create_by(travel: previous_travel1, user: user1, price: previous_travel1.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel1, user: user2, price: previous_travel1.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel1, user: user3, price: previous_travel1.price, status: :rejected)
Ticket.find_or_create_by(travel: previous_travel1, user: user4, price: previous_travel1.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel1, user: email_user, price: previous_travel1.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel1, user: subscribed, price: previous_travel1.price*(1-previous_travel1.discount/100.0), status: :past)
Ticket.find_or_create_by(travel: previous_travel2, user: user2, price: previous_travel2.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel2, user: user3, price: previous_travel2.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel2, user: user4, price: previous_travel2.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel2, user: email_user, price: previous_travel2.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel2, user: subscribed, price: previous_travel2.price*(1-previous_travel2.discount/100.0), status: :past)
Ticket.find_or_create_by(travel: previous_travel3, user: user3, price: previous_travel3.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel3, user: user4, price: previous_travel3.price, status: :absent)
Ticket.find_or_create_by(travel: previous_travel3, user: subscribed, price: previous_travel3.price*(1-previous_travel3.discount/100.0), status: :past)
Ticket.find_or_create_by(travel: previous_travel4, user: user4, price: previous_travel4.price, status: :confirmed)
Ticket.find_or_create_by(travel: previous_travel4, user: subscribed, price: previous_travel4.price*(1-previous_travel4.discount/100.0), status: :past)
Ticket.find_or_create_by(travel: previous_travel5, user: user1, price: previous_travel5.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel5, user: user5, price: previous_travel5.price, status: :past)
...
Ticket.find_or_create_by(travel: previous_travel8, user: user8, price: previous_travel8.price, status: :past)
Ticket.find_or_create_by(travel: previous_travel9, user: user9, price: previous_travel9.price, status: :past)
...
Ticket.find_or_create_by(travel: current_travel2, user: subscribed, price: future_travel2.price*(1-future_travel2.discount/100.0), status: :absent)
Ticket.find_or_create_by(travel: current_travel3, user: user3, price: future_travel3.price, status: :absent)
Ticket.find_or_create_by(travel: current_travel3, user: user4, price: future_travel3.price, status: :confirmed)
Ticket.find_or_create_by(travel: current_travel3, user: subscribed, price: future_travel3.price*(1-future_travel3.discount/100.0), status: :absent)
Ticket.find_or_create_by(travel: current_travel4, user: user5, price: future_travel4.price)
Ticket.find_or_create_by(travel: current_travel5, user: user6, price: future_travel5.price)
